...
import sn.sonatel.dsi.ins.ftsirc.service.OffreQueryService;
...
/**
 * REST controller for managing {@link sn.sonatel.dsi.ins.ftsirc.domain.Offre}.
 */
@RestController
...
public class OffreResource {
    ...
    private static final String ENTITY_NAME = "saytuBackendOffre";
