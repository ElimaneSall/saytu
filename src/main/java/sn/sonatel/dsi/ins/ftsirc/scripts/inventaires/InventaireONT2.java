...
public class InventaireONT2 {

    public static OLTService oltService;
    private static OLTMapper oltMapper;

    InventaireONT2(OLTServiceImpl oltService, OLTMapper oltMapper) {
