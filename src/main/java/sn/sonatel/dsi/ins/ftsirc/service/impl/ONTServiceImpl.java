...
public class ONTServiceImpl implements ONTService {
    ...
    public ONTServiceImpl(ONTRepository oNTRepository, ONTMapper oNTMapper, OLTRepository oltRepository, OLTMapper oltMapper) {
            ...
            for (TreeEvent event : events) {
                ...
                for (VariableBinding varBinding : varBindings) {
                    ...
                    if (olt.getVendeur().equals("NOKIA")) {
                        ...
                        ont.setOntIP(String.valueOf(ontId));
                        listONTs.add(ont);
